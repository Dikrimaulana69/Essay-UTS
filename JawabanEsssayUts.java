...
class JawabanEsssayUts {
    private ArrayList<DataZakatFitriUts> dataWarga;
    public static void main(String[] args) throws Exception {
        JawabanEsssayUts Screen = new JawabanEsssayUts();
        Screen.inputData();
        Screen.cetakData();
    }

    public void inputData() {
        dataWarga = new ArrayList<DataZakatFitriUts>();
        String jawaban;
        int number = 1;
        do {
            ...
            DataZakatFitriUts warga = new DataZakatFitriUts(nama, alamat, metodePembayaran);
            dataWarga.add(warga);
